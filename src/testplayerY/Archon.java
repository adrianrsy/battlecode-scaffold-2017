...
public strictfp class Archon {
    ...
    //Phase turn limits
    static int PHASE_1_TURN_LIMIT = 400;
    ...
    static int PHASE_1_ACTIVE_GARDENER_LIMIT = 20;
    static int PHASE_2_ACTIVE_GARDENER_LIMIT = 8;
    ...
    void runArchonPhase1() throws GameActionException{
        ...
        while(true){
            try{
                ...
                // only move once in a while so that gardeners are hired along its path
                if (turnCount % 6 == 0 || canMove) {
